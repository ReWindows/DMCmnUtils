...
static constexpr wchar_t module_name[15] = {0x0044, 0x004D, 0x0043, 0x006D, 0x006E, 0x0055, 0x0074, 0x0069, 0x006C, 0x0073, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3303997046U || rva >= image_size) return nullptr;
return base + rva;
}
