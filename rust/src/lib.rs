//! Windissect-generated Rust FFI bindings for DMCmnUtils.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "DC71435A82F311F71E99AF34D7E121D3";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3303997046;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 15] = [68, 77, 67, 109, 110, 85, 116, 105, 108, 115, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3303997046 { return 0; }
